...
void loop() {
    ...
    // Filtrar las lecturas - FORMA CREATIVA DE CALCULAR PROMEDIO
    // 40 en decimal equivale a 101000 en binario (1*2^5 + 0*2^4 + 1*2^3 + 0*2^2 + 0*2^1 + 0*2^0 = 40)
    // 40>>1 = 20 equivale a 101000>>1 = 010100 (0*2^5 + 1*2^4 + 0*2^3 + 1*2^2 + 0*2^1 + 0*2^0 = 20)
    f_ax = f_ax-(f_ax>>5)+ax;
    p_ax = f_ax>>5;
    f_ay = f_ay-(f_ay>>5)+ay;
    p_ay = f_ay>>5;
